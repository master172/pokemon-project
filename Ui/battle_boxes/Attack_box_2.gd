...
func _ready():
	if PlayerPokemon.current_pokemon != null:
		if PlayerPokemon.current_pokemon.Learned_moves.size() >= 2:
			...
			Main_label.text = PlayerPokemon.current_pokemon.Learned_moves[1].name
			Type_image.texture = PlayerPokemon.current_pokemon.Learned_moves[1].type_image
			if PlayerPokemon.current_pokemon.Learned_moves[1].effectiveness == 1:
				Effect_image.frame = 2
			elif PlayerPokemon.current_pokemon.Learned_moves[1].effectiveness == 0.5:
				Effect_image.frame = 1
			elif PlayerPokemon.current_pokemon.Learned_moves[1].effectiveness == 2:
