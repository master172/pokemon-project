...
func _ready():
	if PlayerPokemon.current_pokemon != null:
		if PlayerPokemon.current_pokemon.Learned_moves.size() >= 1:
			...
			if PlayerPokemon.current_pokemon.Learned_moves[0].effectiveness == 1:
				Effect_image.frame = 2
			elif PlayerPokemon.current_pokemon.Learned_moves[0].effectiveness == 0.5:
				Effect_image.frame = 1
			elif PlayerPokemon.current_pokemon.Learned_moves[0].effectiveness == 2:
